...
track_moisture_mode = track_moisture_mode.loc[(track_moisture_mode["latitude"].values >= -20.5) & (track_moisture_mode["latitude"].values <= 20.5)]
track_mixed_system = track_mixed_system.loc[(track_mixed_system["latitude"].values >= -20.5) & (track_mixed_system["latitude"].values <= 20.5)]
track_ig_wave = track_ig_wave.loc[(track_ig_wave["latitude"].values >= -20.5) & (track_ig_wave["latitude"].values <= 20.5)]
track_tc = track_tc.loc[(track_tc["latitude"].values >= -20.5) & (track_tc["latitude"].values <= 20.5)]
track_anom = track_anom.loc[(track_anom["latitude"].values >= -20.5) & (track_anom["latitude"].values <= 20.5)]
