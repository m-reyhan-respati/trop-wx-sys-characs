...
script_filename = "calc_count_track_isccp_olr.py"
...
for mode in modes:
    ...
    files = sorted(glob(f"{env_vars['DIRO']}count.track.txuptp.{mode_dict[mode]}.{env_vars['YEAR_START']}-{env_vars['YEAR_END']}.nc"))
