...
env_vars = {}
env_vars["DIRI"] = "/scratch/k10/mr4682/data/ERA5/"
env_vars["FILE_NAME"] = "v"
env_vars["VAR_NAME"] = "v"
env_vars["YEAR_START"] = 1984
env_vars["YEAR_END"] = 2016
env_vars["LAT_NAME"] = "latitude"
env_vars["LON_NAME"] = "longitude"
env_vars["DIRO"] = f"{env_vars['DIRI']}{env_vars['FILE_NAME']}/filtered/"
env_vars["DIRI"] = f"{env_vars['DIRI']}{env_vars['FILE_NAME']}/tmp/"
...
for level in levels:
    ...
    for i in range(0, len(lat_min_list)):
        ...
        files = sorted(glob(f"{env_vars['DIRO']}{env_vars['FILE_NAME']}.*.{env_vars['YEAR_START']}-{env_vars['YEAR_END']}.{lat_min_string}_{lat_max_string}*"))
