...
script_filename = "mse_budget_calc_vi_d_dt.py"
...
env_vars["DIRO"] = f"{SCRATCH_ERA5_DIR}/mse/budget/d_dt/tmp/"
...
for year in years:
    ...
    files = sorted(glob(f"{env_vars['DIRO']}vi_mse_d_dt.{env_vars['YEAR']}.nc"))
