...
script_filename = "resample_gpm.py"
...
env_vars = {}
env_vars["DIRO"] = f"{SCRATCH_GPM_DIR}/3hr_mean_precipitation/1p0deg/"
...
for year in years:
    ...
    files = sorted(glob(f"{env_vars['DIRO']}precipitation.{env_vars['YEAR']}.nc"))
